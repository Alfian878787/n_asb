...
cd ..
cd external/libavc
patch -p1 --forward < ../../device/CUBOT/NOTE_PLUS/patches/n_asb/n_asb_03-2018/external_libavc/04c9906.patch
patch -p1 --forward < ../../device/CUBOT/NOTE_PLUS/patches/n_asb/n_asb_03-2018/external_libavc/db6bf49.patch
git clean -f -d
cd ../..
cd external/libmpeg2
patch -p1 --forward < ../../device/CUBOT/NOTE_PLUS/patches/n_asb/n_asb_03-2018/external_libmpeg2/98beb25.patch
patch -p1 --forward < ../../device/CUBOT/NOTE_PLUS/patches/n_asb/n_asb_03-2018/external_libmpeg2/6337ea6.patch
patch -p1 --forward < ../../device/CUBOT/NOTE_PLUS/patches/n_asb/n_asb_03-2018/external_libmpeg2/d63479b.patch
git clean -f -d
cd ../..
cd frameworks/av
patch -p1 --forward < ../../device/CUBOT/NOTE_PLUS/patches/n_asb/n_asb_03-2018/frameworks_av/f059aa7.patch
git clean -f -d
cd ../..
cd system/bt
